...
class LepubController extends Controller
{
	...
	public function actionImport($bookId)
	{

		

  		$serialized_book_path=Yii::app()->params['serialized'].$bookId;
  		exec("cd ".Yii::app()->params['serialized'].";unzip -o ".$serialized_book_path.".lepub -d ".$bookId);
  		...
  		$serialized_book=unserialize(file_get_contents($serialized_book_path.'/book.ser'));
   		...
   		$new_book->workspace_id="yBwFA9U1KsdGXuAQO54Cskw7nVRt8NfdYlRbVxb7t8Pu";
   		if($new_book->save())
   		{
